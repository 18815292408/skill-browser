...
export function SkillItem({ skill, onCopy }: Props) {
  const displayName = skill.descriptionZh || skill.name;
  const displayDesc = skill.descriptionZh ? skill.description : skill.description;
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-3 hover:bg-gray-750 transition-colors cursor-pointer"
      ...
      <div className="text-gray-300 text-sm mt-1">{displayName}</div>
